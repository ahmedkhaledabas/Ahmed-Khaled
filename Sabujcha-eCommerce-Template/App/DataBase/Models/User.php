...
class User extends Connection implements Crud {
    ...
    $phone,$gender,$status,$verfication_code,$email_verified_at,
    ...
    public function create(){
        ...
        $stmt->bind_param("ssssssi", $this->first_name, $this->last_name, $this->email,$this->password,
        $this->gender,$this->phone,$this->verification_code);
        return $stmt->execute();
    }
