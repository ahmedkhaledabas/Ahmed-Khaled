...
!(function (a, b) {
  ...
  !(function () {
    ...
    (a.innerHTML =
      ...
      (l.phpSerialize = !!a.getElementsByTagName("link").length),
      (l.php5Clone =
  ...
  var da = {
    ...
    _default: l.phpSerialize ? [0, "", ""] : [1, "X<div>", "</div>"],
  };
      ...
      if (((g = a[r]), g || 0 === g))
        if ("object" === n.type(g)) n.merge(q, g.nodeType ? [g] : g);
          ...
          (i = i || p.appendChild(b.createElement("div"))),
            ...
            (m = da[j] || da._default),
            (i.innerHTML = m[1] + n.phpPrefilter(g) + m[2]),
            (f = m[0]);
  ...
  function Ha(a, b, c, d) {
    ...
    if (r || (o > 1 && "string" == typeof q && !l.checkClone && xa.test(q)))
      return a.each(function (e) {
        var f = a.eq(e);
        r && (b[0] = q.call(this, e, f.php())), Ha(f, b, c, d);
      });
    if (
      o &&
  ...
  n.extend({
    ...
    clone: function (a, b, c) {
      ...
      if (
        (l.php5Clone || n.isXMLDoc(a) || !ua.test("<" + a.nodeName + ">")
          ? (f = a.cloneNode(!0))
    ...
    return (
      ...
      g.length > 0 &&
        n
          ...
          .done(function (a) {
            (f = arguments),
              g.php(d ? n("<div>").append(n.parseHTML(a)).find(d) : a);
          })
          .always(
            c &&
              function (a, b) {
