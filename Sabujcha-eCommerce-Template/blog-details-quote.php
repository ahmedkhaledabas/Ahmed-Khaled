    ...
    <div class="breadcrumb-area bg-image-3 ptb-150">
        <div class="container">
            <div class="breadcrumb-content text-center">
                <h3>BLOG DETAILS QUOTE</h3>
                <ul>
                    <li><a href="index.php">Home</a></li>
                    <li class="active">Blog Details Quote</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="single-blog-wrapper">
                            <div class="quote-post mb-55">
                                <div class="quote-content">
                                    ...
                                    <h3>Lorem ipsum dolor sit amet, cons adipicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</h3>
                                    <h6>Tasnim</h6>
                                </div>
                                <div class="post-img">
